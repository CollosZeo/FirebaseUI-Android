...
public class AuthUI {
    ...
    /**
     * Default type of auth picker
     * */
    public static final int AUTH_TYPE_ACTIVITY = 0;
    public static final int AUTH_TYPE_DIALOG = 1;


    @Retention(RetentionPolicy.SOURCE)
    @IntDef({AUTH_TYPE_ACTIVITY, AUTH_TYPE_DIALOG})
    public @interface AuthPickerType {
    }
    ...
    public final class SignInIntentBuilder {
        ...
        @AuthPickerType
        private int mAuthMethodPickerType = AuthUI.AUTH_TYPE_ACTIVITY;
        ...
        public SignInIntentBuilder setAuthMethodPickerType(@AuthPickerType int authMethodPickerType) {
            mAuthMethodPickerType = authMethodPickerType;
            return this;
        }
